...
public class Doctor extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        welcome.setText("Hello "+bundle.getString("Full_Name"));
    ...
    public void onViewInformation (View view){
        Intent intent = new Intent(Doctor.this,Information.class);
   ...
   public void onAppointment (View view){
        Intent intent = new Intent(Doctor.this,AppointmentView.class);
       Bundle bundle= new Bundle();
       bundle.putString("ID",ID);
       bundle.putString("Full_Name",Full_Name);
       intent.putExtras(bundle);
    ...
    public void onTimeTable (View view){
        Intent intent = new Intent(Doctor.this,TimeTable.class);
        Bundle bundle= new Bundle();
        bundle.putString("ID",ID);
        bundle.putString("Full_Name",Full_Name);
        intent.putExtras(bundle);
