...
public class Information extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String json_url = "http://192.168.43.55/hospital/getDoctorInformation.php?id="+ID;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_appointment){
            Intent intent = new Intent(Information.this,AppointmentView.class);
            Bundle bundle= new Bundle();
            bundle.putString("ID",ID);
            bundle.putString("Full_Name",Full_Name);
            intent.putExtras(bundle);
            ...
            Intent intent = new Intent(Information.this,TimeTable.class);
            Bundle bundle= new Bundle();
            bundle.putString("ID",ID);
            bundle.putString("Full_Name",Full_Name);
            intent.putExtras(bundle);
            ...
            Intent intent = new Intent(Information.this, Doctor.class);
            Bundle bundle = new Bundle();
            bundle.putString("ID", ID);
            bundle.putInt("Num", 1);
            bundle.putString("Full_Name", Full_Name);
